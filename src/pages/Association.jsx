...
export default function Association() {
  ...
  const defaultPosition = association?.latitude && association?.longitude ? [association?.latitude, association?.longitude] : [45.755828, 4.895709]; 
  ...
  return (
    <div className={"container " + styles.main}>
      ...
      <div>
      <MapContainer center={defaultPosition} zoom={8} style={{ height: '100vh', width: '100%', minWidth: "350px" }}>
      <TileLayer
        url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
        attribution='&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'
      />
      { association?.latitude && association?.longitude && (
          <Marker position={[association?.latitude, association?.longitude]} />
        )
      }
    </MapContainer>
      </div>
